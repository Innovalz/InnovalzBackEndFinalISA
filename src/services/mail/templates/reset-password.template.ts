  ...
  return `<!DOCTYPE html>
    <html lang="en-US">
      <head>
        ...
        <title>Reset your Innovalz.com account password</title>
      </head>
                      ...
                      <tr>
                        <td style="padding: 0 35px">
                          ...
                          <a
                            ...
                            >Reset Password</a
                          >
                          <p>Note: password will expire after 1 hour</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="height: 40px">&nbsp;</td>
                ...
                <tr>
                  <td style="text-align: center">
                    <p
                      ...
                      "
                    >
                      &copy; <strong>www.innovalz.com</strong>
                    </p>
                  </td>
                </tr>
                <tr>
...
const _resetPasswordTemplate = resetPasswordTemplate;
export { _resetPasswordTemplate as resetPasswordTemplate };
